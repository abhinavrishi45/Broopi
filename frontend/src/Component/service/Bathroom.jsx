    ...
    axios.get("http://localhost:5000/api/product/allproducts")
      .then(res => {
        const pestProducts = res.data.filter(
          product => product.category === "BathroomCleaning"
        );
  ...
  return (
    <div className='flex flex-row'>
      <div className=' border border-gray-200 mt-10 ml-25 rounded py-5 px-7 w-260'>
        ...
        <h className='text-3xl font-bold font-serif '>Bathroom Cleaning</h>
        ...
        <p className='text-3xl mt-5 font-serif font-bold'>Basic</p>
